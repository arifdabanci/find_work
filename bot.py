...
# --- AYARLAR ---
ARAMA_LISTESI = ["Data Curation","Bounding Box","Search Evaluation","Model Evaluation","Prompt Engineering","Data Labeling", "Veri Etiketleme", "Image Annotation", "Computer Vision", "Görüntü İşleme","Nesne Tespiti", "Object Detection", "Veri girişi", "Data review","Web Scraping","Workflow Automation","Computer Vision Intern","Veri Giriş Uzmanı (AI)"] # Burayı "Image Processing" vb. yapabilirsin
